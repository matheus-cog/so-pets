namespace soPets
{
	partial class remocaoConsulta
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(remocaoConsulta));
			...
			this.txtPrognosticos.ReadOnly = true;
			this.txtPrognosticos.Size = new System.Drawing.Size(311, 124);
			this.txtPrognosticos.TabIndex = 100;
			// 
			// label6
			// 
			...
			this.mskCRMV.ReadOnly = true;
			this.mskCRMV.Size = new System.Drawing.Size(100, 15);
			this.mskCRMV.TabIndex = 95;
			...
			this.cmbVeterinario.TabIndex = 93;
			// 
			// btnSalvar
			// 
			...
			this.txtObservacoes.TabIndex = 88;
			// 
			// label11
			// 
			...
			this.Name = "remocaoConsulta";
			this.Text = "remocaoConsulta";
