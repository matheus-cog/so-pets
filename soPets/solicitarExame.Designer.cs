namespace soPets
{
	partial class solicitarExame
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(solicitarExame));
			...
			this.label7.Text = "Veterinário solicitante";
			// 
			// cmbVeterinario
			// 
			...
			this.cmbVeterinario.TabIndex = 32;
			// 
			// label2
			// 
			...
			this.Name = "solicitarExame";
			this.Text = "solicitarExame";
